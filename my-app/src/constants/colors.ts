export const colors = [
    { name: 'Red', bgClass: 'bg-red-500', feeling: 'Anger' },
    { name: 'Orange', bgClass: 'bg-orange-500', feeling: 'Amusement' },
  ...
  // research source for ^ map : https://pmc.ncbi.nlm.nih.gov/articles/PMC7027086/